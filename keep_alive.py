...
def main():
    ...
    total_seconds = 19800
    # هر ۱۰ دقیقه یک‌بار متنی چاپ می‌کنیم تا گیت‌هاب سرور را به دلیل بی‌فعالی خاموش نکند
    interval = 600 
    elapsed = 0

    print("سرور ویندوز با موفقیت آماده استفاده است. زمان‌سنج ۵.۵ ساعته فعال شد.")
